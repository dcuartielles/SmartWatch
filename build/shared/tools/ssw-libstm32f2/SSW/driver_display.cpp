...
void Arduino_GFX::drawLine(int16_t x0, int16_t y0, 
...
void Arduino_GFX::setTextWrap(bool w) {
  wrap = w;
}

// return the size of the display which depends on the rotation!
int16_t Arduino_GFX::width(void) { 
  return _width; 
}
...
void Arduino_OLED::setAddrWindow(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1) {
